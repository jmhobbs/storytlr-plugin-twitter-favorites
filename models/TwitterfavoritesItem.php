<?php
	...
	class TwitterfavoritesItem extends SourceItem {

		protected $_prefix = 'twitterfavorites';

		protected $_preamble = 'Twitter Favorites activity: ';
		...
		public function getAuthor() { return $this->_data['author']; }
		
		public function getAuthorLink() { return 'http://twitter.com/' . $this->_data['author']; }
